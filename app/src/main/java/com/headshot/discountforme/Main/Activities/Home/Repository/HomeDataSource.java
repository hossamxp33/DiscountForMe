...
public class HomeDataSource extends PageKeyedDataSource<Integer, Datum> {
    ...
    public HomeDataSource(String id, String token) {
        this.id = id;
        this.token = token;
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, Datum> callback) {
        ...
        Observable observable = RetroWeb.getClient().create(MainServices.class).home(token, id, FIRST_PAGE)
    ...
    public void loadAfter(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, Datum> callback) {
        ...
        Observable observable = RetroWeb.getClient().create(MainServices.class).home(token, id, params.key)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
        Observer<HomeModel> observer = new Observer<HomeModel>() {
            @Override
