...
public class FilterAndSearchFactory extends DataSource.Factory {
    ...
    public FilterAndSearchFactory(String token, String categories, String order_by) {
    ...
    public DataSource create() {
        ...
        FilterAndSearchDataSource itemDataSource = new FilterAndSearchDataSource(token, categories, order_by);
